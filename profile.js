...
window.PROFILE = {
  ...
  publications: [
    {title:"Support-Conditioned Dynamic Convolution for FSOD",meta:"第一作者 · ICASSP 2026 · CCF-B · 已发表",description:"面向小样本目标检测，研究支持集信息如何引导查询特征的空间滤波与语义对齐。",abstract:"针对样本稀缺时密集注意力模型容易过拟合的问题，提出支持条件动态卷积（SCDC）模块。在 Meta R-CNN 框架内，通过支持集动态生成卷积核与通道调制参数，将支持信息注入查询特征，协同实现空间滤波与语义对齐。"},
    {title:"UINO-FSS: Unifying Representation Learning and Few-shot Segmentation via Hierarchical Distillation and Mamba-HyperCorrelation",meta:"学生第二作者 · IEEE TIP 研究工作",description:"围绕表示学习与小样本分割开展研究。"}
  ],
  experience: [
